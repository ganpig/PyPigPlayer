...
#define MyAppVersion "v1.0 alpha-1"
#define ShortVersion "v1.0a1"
...
OutputDir=D:\Programming\Projects\PyPigPlayer\archive\{#ShortVersion}
OutputBaseFilename=PyPigPlayer_{#ShortVersion}_setup
